...
| Webhook WhatsApp messages-upsert | POST | `/api/webhooks/whatsapp/evolution/messages-upsert` | Nao | Implementado |
| Webhook WhatsApp send-message | POST | `/api/webhooks/whatsapp/evolution/send-message` | Nao | Implementado |
