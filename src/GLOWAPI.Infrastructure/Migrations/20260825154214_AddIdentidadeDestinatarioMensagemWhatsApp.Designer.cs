...
namespace GLOWAPI.Infrastructure.Migrations
{
    ...
    [Migration("20260825154214_AddIdentidadeDestinatarioMensagemWhatsApp")]
    partial class AddIdentidadeDestinatarioMensagemWhatsApp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GLOWAPI.Domain.Entities.CategoriaEstabelecimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CategoriasEstabelecimento", (string)null);
                });
            ...
            modelBuilder.Entity("GLOWAPI.Domain.Entities.Comodidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            CreateAd = new DateTime(2026, 8, 24, 0, 0, 0, 0, DateTimeKind.Utc),
                            Icone = "wifi",
                            Nome = "Wi-Fi",
                            Ordem = 1,
                            Slug = "wi-fi"
            ...
            modelBuilder.Entity("GLOWAPI.Domain.Entities.EstabelecimentoComodidade", b =>
                {
                    b.Property<int>("EstabelecimentoId")
                        .HasColumnType("int");

                    b.Property<int>("ComodidadeId")
                        .HasColumnType("int");

                    b.Property<DateTime>("CreateAd")
                        .HasColumnType("datetime(6)");

                    b.HasKey("EstabelecimentoId", "ComodidadeId");

                    b.HasIndex("ComodidadeId");

                    b.ToTable("EstabelecimentoComodidades", (string)null);
                });
            ...
            modelBuilder.Entity("GLOWAPI.Domain.Entities.FavoritoCliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ProfissionalChave")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UsuarioClienteId", "EstabelecimentoId", "ProfissionalChave")
                        .IsUnique();

                    b.ToTable("FavoritosCliente", (string)null);
                });
            ...
            modelBuilder.Entity("GLOWAPI.Domain.Entities.MensagemNotificacao", b =>
                {
                    ...
                    b.Property<bool>("EhVerificacaoWhatsApp")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("GLOWAPI.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<string>("CodigoAgendamento")
                        .HasMaxLength(32)
            ...
            modelBuilder.Entity("GLOWAPI.Domain.Entities.Estabelecimento", b =>
                {
                    b.HasOne("GLOWAPI.Domain.Entities.CategoriaEstabelecimento", "CategoriaEstabelecimento")
                        .WithMany()
            ...
            modelBuilder.Entity("GLOWAPI.Domain.Entities.EstabelecimentoComodidade", b =>
                {
                    b.HasOne("GLOWAPI.Domain.Entities.Comodidade", "Comodidade")
                        .WithMany("Estabelecimentos")
                        .HasForeignKey("ComodidadeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
